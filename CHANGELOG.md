...
### Changed
- Allow enhanced security policies (TLS_1_3 default, arbitrary policy values). Thank you @mzl-md ([669](https://github.com/amplify-education/serverless-domain-manager/pull/669))
- Updated packages.

## [10.0.0] - 2026-02-26

### Changed
- Dropped Node18 support.
- Updated packages.

## [9.1.1] - 2026-02-25

### Changed
- Fixed `addServiceOutputSection` print for the multiple services usage.
