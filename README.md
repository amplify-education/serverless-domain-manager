...
| securityPolicy | `TLS_1_2` | The security policy to apply to the custom domain name. Any value accepted by AWS API Gateway is valid (e.g. `TLS_1_0`, `TLS_1_2`, `SecurityPolicy_TLS13_2025_EDGE`). |
