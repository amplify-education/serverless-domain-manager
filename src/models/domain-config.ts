...
class DomainConfig {
  ...
  private static _getBasePath (basePath: string | undefined) {
  ...
  private static _getEndpointType (endpointType: string | undefined) {
  ...
  private static _getApiType (apiType: string | undefined) {
